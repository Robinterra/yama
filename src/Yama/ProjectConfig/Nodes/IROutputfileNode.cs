...
{
    public class IROutputFileNode : IDeserialize
    {
        // -----------------------------------------------
        ...
        public IParseTreeNode Parse(RequestParserTreeParser request)
        {
            ...
            if (request.Token.Text.ToLower() != "irout") return null;

            IROutputFileNode result = new IROutputFileNode();
        ...
        private IParseTreeNode CleanUp(IROutputFileNode node)
        {
