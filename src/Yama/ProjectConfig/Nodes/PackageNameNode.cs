...
namespace Yama.ProjectConfig.Nodes
{
    ...
    public class PackageNameNode : IDeserialize
    {
        ...
        public IParseTreeNode? Parse(RequestParserTreeParser request)
        {
            ...
            if (request.Token.Text.ToLower() != "name") return null;

            PackageNameNode result = new PackageNameNode();
