...
namespace Yama.Compiler
{
    ...
    public class CompileMalloc : ICompile<IParseTreeNode>
    {
        ...
        public bool Compile(Compiler compiler, IParseTreeNode node, string mode = "default")
        {
            ...
            foreach (AlgoKeyCall key in this.Algo.Keys)
            {
                ...
                if (result == null) return compiler.AddError(string.Format ("Es konnten keine daten zum Keyword geladen werden 55 {0}", key.Name ), node);
