        ...
        public bool IsUsed
        {
            get
            {
                if (this.CleanMemoryUseErkenner is not null && this.CleanMemoryLocation is not null)
                {
                    ...
                    //if (this.CleanMemoryUseErkenner.First.TryToClean.FlowTask == ProgramFlowTask.CleanMemoryReturn && this.CleanMemoryLocation.FlowTask == ProgramFlowTask.CleanMemoryReturn) return true;
