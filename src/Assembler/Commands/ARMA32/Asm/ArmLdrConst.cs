...
{
    public class ArmLdrConst : ICommand
    {
        ...
        public ArmLdrConst(string key, IFormat ldrFormat, uint ldrId, IFormat bFormat, uint bId, int size)
        {
        ...
        public ArmLdrConst(ArmLdrConst t, IParseTreeNode node, List<byte> bytes)
        {
            this.Key = t.Key;
